...
namespace cured
{
    public partial class registr : Form
    {
        ...
        private Boolean checkuser()
        {
            ...
            string querystring = $"select UserID, Login from Users where Login = '{login_user}'";
            ...
            {
                MessageBox.Show("Такой логин уже существует", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return true;
            }
            else
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(name_user) || string.IsNullOrEmpty(login_user) ||
                string.IsNullOrEmpty(password_user) || string.IsNullOrEmpty(phone_user))
            {
            ...
            string querystring = $"insert into Users(FullName, Login, Password, Phone, Role) values('{name_user}','{login_user}','{password_user}','{phone_user}', 'user')";
